...
#     NAME => q[Blog]
#     NO_META => q[1]
#     PREREQ_PM => { Authentication=>q[0], Catalyst::Action::RenderView=>q[0], Catalyst::DBD::DBIC=>q[0], Catalyst::Model::DBIC=>q[0], Catalyst::Plugin::ConfigLoader=>q[0], Catalyst::Plugin::Static::Simple=>q[0], Catalyst::Runtime=>q[5.90090], Catalyst::View::TT=>q[0], Config::General=>q[0], ExtUtils::MakeMaker=>q[6.36], Moose=>q[0], Session=>q[0], Session::State::Cookie=>q[0], Session::Store::File=>q[0], Test::More=>q[0.88], catalyst::Plugin::StackTrace=>q[0], namespace::autoclean=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION => q[0.01]
#     VERSION_FROM => q[lib/Blog.pm]
#     dist => { PREOP=>q[$(PERL) -I. "-MModule::Install::Admin" -e "dist_preop(q($(DISTVNAME)))"] }
#     realclean => { FILES=>q[MYMETA.yml] }
#     test => { TESTS=>q[t/01app.t t/02pod.t t/03podcoverage.t t/controller_Comments.t t/controller_Posts.t t/controller_Users.t t/model_DB.t t/view_HTML.t] }
...
MAKEMAKER   = /home/haw/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 7.04
MM_REVISION = 70400
...
MAN3PODS = lib/Blog.pm \
	lib/Blog/Controller/Comments.pm \
	lib/Blog/Controller/Posts.pm \
	lib/Blog/Controller/Root.pm \
	lib/Blog/Controller/Users.pm \
	lib/Blog/Model/DB.pm \
	lib/Blog/Schema/Result/Comment.pm \
...
PM_TO_BLIB = lib/Blog.pm \
	blib/lib/Blog.pm \
	lib/Blog/Controller/Comments.pm \
	blib/lib/Blog/Controller/Comments.pm \
	lib/Blog/Controller/Posts.pm \
	blib/lib/Blog/Controller/Posts.pm \
	lib/Blog/Controller/Root.pm \
	...
	lib/Blog/Schema/Result/Comment.pm \
	blib/lib/Blog/Schema/Result/Comment.pm \
	lib/Blog/Schema/Result/Post.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  ...
	  lib/Blog/Controller/Comments.pm $(INST_MAN3DIR)/Blog::Controller::Comments.$(MAN3EXT) \
	  lib/Blog/Controller/Posts.pm $(INST_MAN3DIR)/Blog::Controller::Posts.$(MAN3EXT) \
	  ...
	  lib/Blog/Schema/Result/Comment.pm $(INST_MAN3DIR)/Blog::Schema::Result::Comment.$(MAN3EXT) \
...
pure_all :: $(INST_SCRIPT)/blog_server.pl $(INST_SCRIPT)/blog_cgi.pl $(INST_SCRIPT)/blog_fastcgi.pl $(INST_SCRIPT)/blog_test.pl $(INST_SCRIPT)/blog_create.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/blog_server.pl $(INST_SCRIPT)/blog_cgi.pl \
	  $(INST_SCRIPT)/blog_fastcgi.pl $(INST_SCRIPT)/blog_test.pl \
	  $(INST_SCRIPT)/blog_create.pl 
...
TEST_FILE = test.pl
TEST_FILES = t/01app.t t/02pod.t t/03podcoverage.t t/controller_Comments.t t/controller_Posts.t t/controller_Users.t t/model_DB.t t/view_HTML.t
TESTDB_SW = -d
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>haw,,,</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Authentication::" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Catalyst::Action::RenderView" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Catalyst::DBD::DBIC" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Catalyst::Model::DBIC" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Catalyst::Runtime" VERSION="5.90090" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Session::" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Session::State::Cookie" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Session::Store::File" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  ...
	  lib/Blog/Controller/Comments.pm blib/lib/Blog/Controller/Comments.pm \
	  lib/Blog/Controller/Posts.pm blib/lib/Blog/Controller/Posts.pm \
	  ...
	  lib/Blog/Schema/Result/Comment.pm blib/lib/Blog/Schema/Result/Comment.pm \
...
installdeps ::
	$(PERL) Makefile.PL --config= --installdeps=catalyst::Plugin::StackTrace,0,Catalyst::Model::DBIC,0,Catalyst::DBD::DBIC,0,Authentication,0,Session,0,Session::Store::File,0,Session::State::Cookie,0

installdeps_notest ::
	$(PERL) Makefile.PL --config=notest,1 --installdeps=catalyst::Plugin::StackTrace,0,Catalyst::Model::DBIC,0,Catalyst::DBD::DBIC,0,Authentication,0,Session,0,Session::Store::File,0,Session::State::Cookie,0

upgradedeps ::
	$(PERL) Makefile.PL --config= --upgradedeps=catalyst::Plugin::StackTrace,0,Catalyst::Model::DBIC,0,Catalyst::DBD::DBIC,0,Authentication,0,Session,0,Session::Store::File,0,Session::State::Cookie,0,Test::More,0.88,Catalyst::Runtime,5.90090,Catalyst::Plugin::ConfigLoader,0,Catalyst::Plugin::Static::Simple,0,Catalyst::Action::RenderView,0,Moose,0,namespace::autoclean,0,Config::General,0,Catalyst::View::TT,0

upgradedeps_notest ::
	$(PERL) Makefile.PL --config=notest,1 --upgradedeps=catalyst::Plugin::StackTrace,0,Catalyst::Model::DBIC,0,Catalyst::DBD::DBIC,0,Authentication,0,Session,0,Session::Store::File,0,Session::State::Cookie,0,Test::More,0.88,Catalyst::Runtime,5.90090,Catalyst::Plugin::ConfigLoader,0,Catalyst::Plugin::Static::Simple,0,Catalyst::Action::RenderView,0,Moose,0,namespace::autoclean,0,Config::General,0,Catalyst::View::TT,0

listdeps ::
	@$(PERL) -le "print for @ARGV" catalyst::Plugin::StackTrace Catalyst::Model::DBIC Catalyst::DBD::DBIC Authentication Session Session::Store::File Session::State::Cookie

listalldeps ::
	@$(PERL) -le "print for @ARGV" catalyst::Plugin::StackTrace Catalyst::Model::DBIC Catalyst::DBD::DBIC Authentication Session Session::Store::File Session::State::Cookie Test::More Catalyst::Runtime Catalyst::Plugin::ConfigLoader Catalyst::Plugin::Static::Simple Catalyst::Action::RenderView Moose namespace::autoclean Config::General Catalyst::View::TT
